...
const STATS = [
  {
    number: "50,000+",
    label: "Special Ed Professionals",
    description: "Teachers, SLPs, OTs, BCBAs, and directors using AbleSpace daily",
  },
  {
    number: "10,000+",
    label: "Progress Notes Generated",
    description: "AI-written notes that save hours of documentation time each week",
  },
  {
    number: "10M+",
    label: "Data Points Logged",
    description: "Across goals, sessions, service minutes, and student milestones",
  },
];
