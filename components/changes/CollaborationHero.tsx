    ...
    <section className="py-32">
      <div className="container mx-auto overflow-hidden px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative mx-auto max-w-screen-lg">
          ...
          {/* Animated cursors */}
          <motion.img
            src="/assets/final/landing-page/collaboration-section-cursor-1.png"
            alt=""
            aria-hidden
            className="pointer-events-none absolute z-20 h-auto w-10 sm:w-12"
            initial={{ left: "12%", top: "20%" }}
            animate={{
              left: ["12%", "62%", "55%", "20%", "12%"],
              top: ["20%", "30%", "65%", "55%", "20%"],
            }}
          ...
          />
          <motion.img
            src="/assets/final/landing-page/collaboration-section-cursor-2.png"
            alt=""
            aria-hidden
            className="pointer-events-none absolute z-20 h-auto w-10 sm:w-12"
