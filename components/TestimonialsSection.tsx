...
const TESTIMONIALS: Testimonial[] = [
  ...
  {
    quote: "The AI-generated progress notes alone save me hours every week. My team can't imagine going back to the old way.",
    name: "James Okafor",
    role: "School Psychologist",
  },
  {
    quote: "Finally an app that actually understands special ed workflows. The graphs and reports are exactly what our district needs.",
    name: "Linda Tran",
...
function TestimonialCard({ quote, name, role }: Testimonial) {
  return (
    <div className="flex flex-col p-7 bg-white border border-[#EFEFEF] rounded-2xl">
      ...
      <p className="text-[15px] text-[#333333] leading-relaxed mb-6 flex-1">"{quote}"</p>
      <div>
      ...
      <div className="max-w-[1080px] mx-auto">
        ...
        <div className="text-center mb-10 sm:mb-14">
          ...
          <p className="text-base sm:text-lg font-medium text-[#666666] leading-relaxed max-w-[720px] mx-auto">
            Thousands of special ed professionals trust AbleSpace to manage their caseloads every day.
          </p>
        </div>
