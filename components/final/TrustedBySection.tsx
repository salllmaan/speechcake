...
const TRUSTED_BY_LOGOS = [
  ...
  { file: "qacps.png",                 alt: "Queen Anne's County Public Schools" },
  ...
  { file: "district-01.png",           alt: "Partner district" },
...
export default function TrustedBySection() {
  return (
    <section className="w-full bg-white py-12">
      <div className="mx-auto max-w-5xl px-2 sm:px-4 overflow-hidden [mask-image:linear-gradient(to_right,transparent,black,transparent)]">
